...
//		Thread.sleep(3000);
//		WebElement homeLink = driver.findElement(By.xpath("//a[@href='https://anhtester.com/']"));
...
//
	    ...
	    WebElement signUpLink = wait.until(ExpectedConditions.elementToBeClickable(
	        By.cssSelector(".navbar__link.navbar__link--signup.navbar__link--tappable.navbar__link-text.navbar__link-text--medium.navbar__link-text--normal-case")	    )); //nếu trên trang mình mở lên chưa load được nội dung cần tìm thì dùng wait.until sẽ ngon hơn,
